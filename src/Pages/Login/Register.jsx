...
import img from '../../../src/assets/images/banner/1544601251919.png';
 ...
 <img src={img} alt="" className="w-96" />
                ...
                <div className="hero-content ">
                    ...
                    <div className="card flex-shrink-0 bg-sky-800  w-full max-w-sm shadow-2xl ">
                        ...
                        <p className="p-3">Already have an account <Link className="text-orange-400 font-bold" to="/login">Login</Link></p>
                    </div>
                </div>
                </div>
            </div>
